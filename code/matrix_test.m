...
lat = [20 20 20 20 20; 15 15 15 15 15; 10 10 10 10 10; 5 5 5 5 5; 0 0 0 0 0];
lon = [0 5 10 15 20; 0 5 10 15 20; 0 5 10 15 20; 0 5 10 15 20; 0 5 10 15 20];

% counting the values in specified bins
N = histcounts2(var_table.latitude, var_table.longitude, flipud(lat(:,1)), lon(1,:)); %lat matrix is upside down becasue values must increase 
